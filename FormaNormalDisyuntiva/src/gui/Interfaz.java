...
public class Interfaz extends JFrame {
	...
	private void createUIComponents() {
		...
		disyuncion = new JButton("Operador (v)");
		...
		implicacion = new JButton("Operador (→)");
		...
		equivalencia = new JButton("Operador (↔)");
	...
	/**
	 * @param panelOperadores
	 *            the panelOperadores to set
	 */
	...
	/**
	 * @param entradaDeTexto
	 *            the entradaDeTexto to set
	 */
	...
	/**
	 * @param entradaDeOperador
	 *            the entradaDeOperador to set
	 */
	...
	/**
	 * @param entradaDeFormaAtomica
	 *            the entradaDeFormaAtomica to set
	 */
